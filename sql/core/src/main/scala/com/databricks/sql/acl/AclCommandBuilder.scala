...
import com.databricks.sql.parser.DatabricksSqlBaseParser
import com.databricks.sql.parser.DatabricksSqlBaseParser._
import com.databricks.sql.parser.DatabricksSqlCommandBuilder

import org.apache.spark.sql.catalyst.parser.{ParseException, ParserUtils}
import org.apache.spark.sql.catalyst.plans.logical.LogicalPlan

/**
 * Adds support for parsing Acl-related commands to [[DatabricksSqlParser]].
 *
 * @note that by extending [[DatabricksSqlCommandBuilder]], this class is also capable of
 * parsing non-Acl related commands such as "VACUUM".
 */
class AclCommandBuilder(client: AclClient)
  extends DatabricksSqlCommandBuilder {
